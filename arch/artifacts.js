var Artifacts = [
  ...
  
  {
	...
	//(x / 50000000 (50M))%, where x is evil spells this R.
      return (save.spells[1].c + save.spells[1].r + save.spells[8].c + save.spells[8].r + save.spells[15].c + save.spells[15].r + save.spells[15].c + save.spells[15].r + + save.spells[11].c + save.spells[11].r + save.spells[4].c + save.spells[4].r) / 500000000000;
    },
    required: function (value) {
